...
start_btn.onclick = (e) => {
    ...
    let p1Village = document.getElementById("p1Village");
    let p2Name = document.getElementById("p2Name");
    let p2Phone = document.getElementById("p2Phone");
    let p2Village = document.getElementById("p2Village");
    if (p1Name.value == '') {
        alert('Please Enter Player1 Name');
    } else if (p1Phone.value == '') {
        alert('Please Enter Player1 Phone Number');
    } else if (p1Village.value == '') {
        alert('Please Enter Player1 Village');
    } else if (p2Name.value == '') {
        alert('Please Enter Player2 Name');
    } else if (p2Phone.value == '') {
        alert('Please Enter Player2 Phone Number');
    } else if (p2Village.value == '') {
        alert('Please Enter Player2 Village');
    }
     else {
...
function myFunction() {
    //  Player1 Details Show 
    let p1Name = document.getElementById("p1Name");
    let p1NameShow = document.getElementById("p1NameShow");
    p1NameShow.textContent = p1Name.value;
    p1Name.value = '';

    let p1Phone = document.getElementById("p1Phone");
    let p1PhoneShow = document.getElementById("p1PhoneShow");
    p1PhoneShow.textContent = p1Phone.value;
    p1Phone.value = '';
    
    let p1Village = document.getElementById("p1Village");
    let p1VillageShow = document.getElementById("p1VillageShow");
    p1VillageShow.textContent = p1Village.value;
    p1Village.value = '';


    //  Player2 Details Show 
    let p2Name = document.getElementById("p2Name");
    let p2NameShow = document.getElementById("p2NameShow");
    p2NameShow.textContent = p2Name.value;
    p2Name.value = '';

    let p2Phone = document.getElementById("p2Phone");
    let p2PhoneShow = document.getElementById("p2PhoneShow");
    p2PhoneShow.textContent = p2Phone.value;
    p2Phone.value = '';

    let p2Village = document.getElementById("p2Village");
    let p2VillageShow = document.getElementById("p2VillageShow");
    p2VillageShow.textContent = p2Village.value;
    p2Village.value = '';
}
// let user = [];
